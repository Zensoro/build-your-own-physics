...
# AI Collaboration Prompts · Challenge 10 · Relativity

> Copy the prompts below to your AI assistant (ChatGPT / Claude / Doubao / DeepSeek),
> and it becomes your personal tutor for Challenge 10.

## Full prompt (copy once)

```
I am working through Challenge 10 of the "Build Your Own Physics" repository: Relativity.

【My background】I started from zero and have completed the Python and physics foundations of Challenges 00–09 (matrix basics + experience from Challenge 03).

【Physics goals】Understand: the Lorentz transformation, the invariant spacetime interval, length contraction and time dilation, and the Minkowski spacetime diagram.
