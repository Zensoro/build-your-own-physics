...
# AI Collaboration Prompts · Challenge 07 · Double Pendulum

> Copy the prompts below to your AI assistant (ChatGPT / Claude / Doubao / DeepSeek),
> and it becomes your personal tutor for Challenge 07.

## Full prompt (copy once)

```
I am working through Challenge 07 of the "Build Your Own Physics" repository: the Double Pendulum.

[My background] I'm a complete beginner. I have finished the Python and physics fundamentals from Challenges 00–06 (experience from Challenge 02 + intuition for calculus (math supply station)).

[Physics goals] Understand: chaos, the unpredictability of deterministic systems, the Lyapunov exponent, and the RK4 method.
