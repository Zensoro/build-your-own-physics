...
> This is the starter code for Challenge 03. **Your job is to fill in the `TODO`s.**
...
## About the unit system (important)

We use the **AU-year system** (recommended — the numbers are friendlier):
- Distance unit: AU (1 AU = the Earth–Sun distance)
- Time unit: years
- Gravitational parameter $\mu = GM = 4\pi^2$ AU³/yr²

In this unit system, Earth's circular orbital speed comes out to exactly $v = 2\pi$ AU/yr and its period to exactly 1 year. Kepler's third law is automatically satisfied as $T^2 = a^3$ (in the AU-year system).
...
- [ ] Circular orbit: a perfect circle that closes after one year
- [ ] Elliptical orbit (0.8 v): the Sun sits at one focus of the ellipse
- [ ] Energy plot: an almost perfectly horizontal line (the magic of the leapfrog method)
