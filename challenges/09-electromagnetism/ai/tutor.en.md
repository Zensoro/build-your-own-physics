...
# AI Collaboration Prompts · Challenge 09 · Electromagnetism

> Copy the prompts below to your AI assistant (ChatGPT / Claude / Doubao / DeepSeek),
> and it becomes your personal tutor for Challenge 09.

## Full Prompt (copy once)

```
I'm working through Challenge 09 of the "Build Your Own Physics" repository: Electromagnetism.

【My background】I'm starting from scratch and have completed the Python and physics basics of Challenges 00–08 (array operations + the experience from Challenge 05).

【Physics goals】Understand: Maxwell's equations, electromagnetic waves, Yee-grid FDTD, impedance matching, and the reflection coefficient.
