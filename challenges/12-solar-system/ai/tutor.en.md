...
# AI Collaboration Prompts · Challenge 12 · Solar System

> Copy the prompts below to your AI assistant (ChatGPT / Claude / Doubao / DeepSeek),
> and it becomes your personal tutor for Challenge 12.

## Full prompt (copy once)

```
I am working through Challenge 12 of the "Build Your Own Physics" repository: Solar System.

【My background】I started from zero and have completed the Python and physics foundations of Challenges 00–11 (all the experience from Challenges 01–11).

【Physics goals】Understand: combining all tools — multi-body integration, energy monitoring, relativistic corrections, and Kepler's-law verification.
