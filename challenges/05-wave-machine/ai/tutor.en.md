...
# AI Collaboration Prompts · Challenge 05 · Wave Equation (Wave Machine)

> Copy the prompt below to your AI assistant (ChatGPT / Claude / Doubao / DeepSeek),
> and it becomes your personal tutor for Challenge 05.

## Full prompt (copy once)

```
I'm working through Challenge 05 of the "Build Your Own Physics" repository: the wave equation (Wave Machine).

[My background] I'm starting from scratch and have completed the Python and physics foundations of Challenges 00–04 (arrays + experience from Challenge 04).

[Physics goals] Understand: the wave equation, wave speed, standing waves, interference, boundary reflection, and the CFL stability condition.
